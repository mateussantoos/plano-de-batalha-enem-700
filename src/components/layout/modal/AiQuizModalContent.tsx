...
export default function AiQuizModalContent({
  ...
  return (
    <div className="w-full ">
      <div className="text-center mb-8 scrollbar-hide   ">
      ...
      <div
        className={`grid grid-cols-1 ${
          isFinished ? "lg:grid-cols-2 gap-8" : ""
        }`}
      >
        {isFinished && (
          <div className="bg-gradient-to-br from-green-50 to-blue-50 p-6 rounded-2xl border-2 border-green-200 order-last lg:order-first shadow-lg scrollbar-hide max-h-[60vh] overflow-y-auto">
            <h4 className="font-black text-center mb-4 text-gray-800 uppercase tracking-wide">
              🏆 Resumo da IA
            </h4>
            <div className="text-center mb-6">
              ...
              <div className="bg-white rounded-full w-20 h-20 mx-auto flex items-center justify-center shadow-lg border-4 border-green-200">
            ...
            {isAnalyzing ? (
              ...
              <div
                className="text-sm prose prose-sm max-w-none bg-white p-4 rounded-xl shadow-sm"
          ...
          {questions.map((q, index) => (
            ...
            >
              <div className="flex items-center mb-4">
                <div
                  className={`p-3 h-8 rounded-full flex items-center justify-center text-white font-bold text-sm mr-3 ${
                    isFinished
                      ? selectedAnswers[index] === q.correct_answer_index
                        ? "bg-green-500"
                        : "bg-red-500"
              ...
              <div className="space-y-3">
                {q.options.map((opt, i) => {
                  ...
                  return (
                    <label
                      key={i}
                      className={`flex items-start p-4 text-base rounded-xl border-2 border-gray-300 cursor-pointer transition-all duration-200 font-semibold
                        ${
                          isFinished
                            ? isCorrect
                    ...
                    >
                      <input
                        ...
                        className="mr-3 mt-1 w-4 h-4 text-green-600 focus:ring-green-500 "
                      />
                      {opt}
                    </label>
                  );
              ...
              {isFinished && (
                <div className="mt-4 p-4 bg-yellow-50 border-2 border-yellow-200 rounded-xl">
                  <div className="flex items-start">
                    ...
                    <div>
                      <strong className="font-bold text-yellow-800 block mb-1">
                        Explicação:
                      </strong>
